...
class _PendingTasksPageState extends State<PendingTasksPage> {
  ...
  Future<void> _sendReminderToPi(String taskName, int scheduledTime) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Reminder sent to Raspberry Pi for task: $taskName'),
        ),
      );
    } catch (e) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Error sending reminder: $e')));
    }
  }
  ...
  Future<void> _markTaskAsDone(String taskId) async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Task marked as done!')));
    } catch (e) {
      ScaffoldMessenger.of(
        context,
          ...
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final taskDateTime = DateTime.fromMillisecondsSinceEpoch(
                  scheduledTime,
                );
                ...
                return Card(
                  child: ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        Text(
                          'Scheduled: ${DateFormat('yyyy-MM-dd HH:mm').format(taskDateTime)}',
                        ),
